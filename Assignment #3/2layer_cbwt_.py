...
Original file is located at
    https://colab.research.google.com/drive/1N_hDIKzYQ1nW6MnfeFm9dGxEI5Zidwg5
"""
...
for i in range(1,num_tasks_to_run):
  CBWT.append((1/(10-i))*(np.sum(R_matrix[i,i+1:],axis=0)-R_matrix[i,i]))

print(((1/9)*np.sum(R_matrix[num_tasks_to_run-1,:-1])-0.88))
