# -*- coding: utf-8 -*-
"""gradient_decent_optimizer_gpu.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZV2uN1SfcZotnSk1gvBLfm0acwb989b1
"""
...
mlp_on_cpu = MLP(size_input, size_hidden_1,size_hidden_2, size_output, device='gpu')
...
#Initialize model using CPU
mlp_on_cpu = MLP(size_input, size_hidden_1,size_hidden_2,size_hidden_3, size_output, device='gpu')
time_start = time.time()
for task in range(num_tasks_to_run):
  input_kir = each_task_data[task]
  label_kir = train.labels
...
#Initialize model using CPU
mlp_on_cpu = MLP(size_input, size_hidden_1,size_hidden_2,size_hidden_3,size_hidden_4, size_output, device='gpu')
time_start = time.time()
for task in range(num_tasks_to_run):
  input_kir = each_task_data[task]
  label_kir = train.labels
