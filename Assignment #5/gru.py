...
Original file is located at
    https://colab.research.google.com/drive/1HszeZLojlm_sjC3oU27ExXeqzQAXtH0S
"""
...
# dataset loading
pickle_in = open("./data/notMNIST.pickle","rb")
...
class BasicLSTM(tf.keras.Model):
    ...
    def call(self, inputs, training=None, mask=None, initial_states=None):
        ...
        for t in range(inputs.shape[1]):
            ...
            z2 = self.recurrent_kernel(r*h_state)[:,2*self.units:3*self.units]
            # z3 = z[:, 3 * self.units:]
